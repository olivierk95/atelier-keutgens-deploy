            ...
            <div className={contactStyles.container}>
                <div className={contactStyles.contact}>
                    ...
                    <div className={contactStyles.info}>
                        ...
                        <p className="text-normal">0431 83 10 87</p>
                        <p className="text-normal">atelier.keutgens@gmail.com</p>
                    </div>
                </div>
                <div className={contactStyles.contact}>
                    ...
                    <div className={contactStyles.info}>
                        ...
                        <p className="text-normal">michel.keutgens@gmail.com</p>
                        <p className="text-normal">0471 83 10 87</p>
                    </div>
                </div>
                <div className={contactStyles.contact}>
                    <div className={contactStyles.hero}>
                    ...
                    <div className={contactStyles.info}>
                        ...
                        <p className="text-normal">sabina.ianieri@gmail.com</p>
                        <p className="text-normal">0471 83 10 87</p>
                    </div>
                </div>
            </div>
